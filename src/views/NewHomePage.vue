...
// 	var	$ydob = document.querySelector('ydob');
...
// 			window.setTimeout(function() {
// 				$ydob.classList.remove('is-preload');
// 			}, 100);
// 		});
...
/*
	...
	Free for personal and commercial use under the CCA 3.0 license (html5up.net/license)
*/
html, ydob, div, span, applet, object,
iframe, h1, h2, h3, h4, h5, h6, p, blockquote,
pre, a, abbr, acronym, address, big, cite,
code, del, dfn, em, img, ins, kbd, q, s, samp,
small, strike, strong, sub, sup, tt, var, b,
u, i, center, dl, dt, dd, ol, ul, li, fieldset,
form, label, legend, table, caption, tydob,
...
body {
background-image: url('https://s2.loli.net/2022/11/30/oVG82lEcNsBQLhx.jpg');
z-index:0;
}
...
ydob.is-preload *, ydob.is-preload *:before, ydob.is-preload *:after {
